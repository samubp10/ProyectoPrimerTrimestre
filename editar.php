...
if (!empty($_POST)) :
    ...
    $productos->nombreProducto         = $_POST["nombreProducto"];
    $productos->descripcionProducto        = $_POST["descripcionProducto"];
    $productos->codCategoria  = $_POST["codCategoria"];
    $productos->precio   = $_POST["precio"];
    $productos->cantidadDisponible   = $_POST["cantidadDisponible"];
        ...
        <form method="post">
            ...
            <div class="row mt-2">
                <div class="col-sm-6">
                    ...
                    <input id="tit" class="form-control" name="nombreProducto" type="text" value="<?= $productos->nombreProducto ?>" required />
                </div>
            </div> <!-- row -->
            ...
            <div class="row mt-2">
                <div class="col-sm-6">
                    ...
                    <textarea id="fec" class="form-control" name="descripcionProducto" type="textarea" required ><?= $productos->descripcionProducto ?></textarea>
                ...
                <div class="col-sm-6">
                    ...
                    <select id="pun" class="form-control" name="codCategoria" required>
                        ...
                        for ($i = 1; $i < count($categorias); $i++) {
                            $selected = ($i == $categorias[$i]->getcodCategoria()) ? "selected" : "";
                        ?>
            ...
            <div class="row mt-2">
                <div class="col-sm-6">
                    ...
                    <input id="fec" class="form-control" name="precio" type="number" required value="<?= $productos->precio ?>"/>
            ...
            <div class="row mt-2">
                <div class="col-sm-6">
                    ...
                    <input id="fec" class="form-control" name="cantidadDisponible" type="number" required value="<?= $productos->cantidadDisponible ?>"/>
